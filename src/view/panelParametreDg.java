...
public class panelParametreDg extends JPanel implements ActionListener{
	...
	public panelParametreDg() {
		...
		vectDg = controller.ControllerDB.getDirectionGeneraleArbre();
	...
	private class MyButtonListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			if(source == btnModifierDG){
				...
				if(textFieldModifDG.getText()!= null && textFieldModifDG.getText().length()>0 ){
					...
					controller.ControllerDB.ModifDg(directionGenerale);
					controller.gestionFenetre.eraseContainerPaneMainJFrame();
					controller.gestionFenetre.configurationModif(false);	
				}
				else
			...
			if(source == btnAjouterDG){
				if(textFieldAjoutDG.getText()!= null && textFieldAjoutDG.getText().length()>0 ){
					...
					controller.addData.addDirectionGenerale(directionGenerale);
					controller.gestionFenetre.eraseContainerPaneMainJFrame();
		...
		private void remplirDG(String directionGenerale	){
			...
			directionGeneraleArbre directionGeneraleArbre = ControllerDB.getDirectionGeneraleArbre(directionGenerale);
