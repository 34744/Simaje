...
public class compoCelluleJFrame extends JFrame implements ActionListener{
	...
	public compoCelluleJFrame(String numUlis, JTable table) {
		...
		vectCellule = controller.ControllerDB.getCelluleNonUtilisee(idUtilisateur);
	...
	private class MyButtonListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(source == btnValider){
				...
				controller.addData.addCompoCellule(compoCellule);
				table.removeAll();
				table.repaint();
				table.requestFocus();
				hide();
